...
// Error
// file glthreads.c line 93
static void Error(const char *msg);
// MakeNewTexture
// file glthreads.c line 110
...
extern unsigned long int XCreateWindow(struct _XDisplay *, unsigned long int, signed int, signed int, unsigned int, unsigned int, unsigned int, signed int, unsigned int, struct anonymous$11 *, unsigned long int, struct anonymous$29 *);
// XDestroyWindow
...
extern signed int XLookupString(struct anonymous$35 *, char *, signed int, unsigned long int *, struct _XComposeStatus *);
// XMapWindow
...
extern signed int XSetNormalHints(struct _XDisplay *, unsigned long int, struct anonymous$5 *);
// XSetStandardProperties
// file /usr/include/X11/Xutil.h line 617
extern signed int XSetStandardProperties(struct _XDisplay *, unsigned long int, const char *, const char *, unsigned long int, char **, signed int, struct anonymous$5 *);
// XSync
...
// clean_up
// file glthreads.c line 535
static void clean_up(void);
// cos
// file /usr/include/x86_64-linux-gnu/bits/mathcalls.h line 63
extern double cos(double);
// create_window
// file glthreads.c line 446
static void create_window(struct winthread *wt, struct __GLXcontextRec *shareCtx);
// draw_loop
// file glthreads.c line 236
static void draw_loop(struct winthread *wt);
// draw_object
// file glthreads.c line 155
static void draw_object(void);
// event_loop
// file glthreads.c line 354
static void event_loop(struct _XDisplay *dpy);
// event_loop_multi
// file glthreads.c line 413
...
extern struct anonymous$33 * glXChooseVisual(struct _XDisplay *, signed int, signed int *);
// glXCreateContext
// file /usr/include/GL/glx.h line 190
extern struct __GLXcontextRec * glXCreateContext(struct _XDisplay *, struct anonymous$33 *, struct __GLXcontextRec *, signed int);
// glXDestroyContext
...
extern signed int pthread_cond_init(union anonymous$44 *, const union anonymous *);
// pthread_cond_wait
// file /usr/include/pthread.h line 991
extern signed int pthread_cond_wait(union anonymous$44 *, union anonymous$41 *);
// pthread_create
...
extern signed int pthread_mutex_init(union anonymous$41 *, const union anonymous *);
// pthread_mutex_lock
// file /usr/include/pthread.h line 764
extern signed int pthread_mutex_lock(union anonymous$41 *);
// pthread_mutex_unlock
// file /usr/include/pthread.h line 775
extern signed int pthread_mutex_unlock(union anonymous$41 *);
// resize
// file glthreads.c line 222
static void resize(struct winthread *wt, signed int w, signed int h);
// signal_redraw
// file glthreads.c line 101
static void signal_redraw(void);
// strcmp
// file /usr/include/string.h line 144
extern signed int strcmp(const char *, const char *);
// thread_function
// file glthreads.c line 523
static void * thread_function(void *p);
// usage
// file glthreads.c line 552
...
struct anonymous$5
{
  ...
  // min_aspect
  struct anonymous$3 min_aspect;
  // max_aspect
  struct anonymous$3 max_aspect;
  // base_width
...
union _XEvent
{
  ...
  // xkey
  struct anonymous$35 xkey;
  // xbutton
  struct anonymous$9 xbutton;
  // xmotion
  struct anonymous$15 xmotion;
  // xcrossing
  ...
  // xcreatewindow
  struct anonymous$8 xcreatewindow;
  // xdestroywindow
  ...
  // xcirculate
  struct anonymous$0 xcirculate;
  // xcirculaterequest
  struct anonymous$2 xcirculaterequest;
  // xproperty
  struct anonymous$6 xproperty;
  // xselectionclear
  struct anonymous$7 xselectionclear;
  // xselectionrequest
  struct anonymous$10 xselectionrequest;
  // xselection
  struct anonymous$13 xselection;
  // xcolormap
  struct anonymous$16 xcolormap;
  // xclient
  struct anonymous$20 xclient;
  // xmapping
  struct anonymous$25 xmapping;
  // xerror
  struct anonymous$27 xerror;
  // xkeymap
  struct anonymous$28 xkeymap;
  // xgeneric
  struct anonymous$30 xgeneric;
  // xcookie
  struct anonymous$31 xcookie;
  // pad
...
// Animate
// file glthreads.c line 85
static unsigned char Animate = (unsigned char)1;
// CondMutex
// file glthreads.c line 89
static union anonymous$41 CondMutex;
// CondVar
// file glthreads.c line 88
static union anonymous$44 CondVar;
// ExitFlag
// file glthreads.c line 79
static volatile unsigned char ExitFlag = (volatile unsigned char)0;
// Locking
// file glthreads.c line 82
static unsigned char Locking = (unsigned char)0;
// MultiDisplays
// file glthreads.c line 81
static unsigned char MultiDisplays = (unsigned char)0;
// Mutex
// file glthreads.c line 87
static union anonymous$41 Mutex;
// NumWinThreads
// file glthreads.c line 78
static signed int NumWinThreads = 0;
// TexObj
// file glthreads.c line 84
static unsigned int TexObj = (unsigned int)12;
// Texture
// file glthreads.c line 83
static unsigned char Texture = (unsigned char)0;
// WinThreads
// file glthreads.c line 77
...
static void clean_up(void)
{
  ...
  for( ; !(i >= NumWinThreads); i = i + 1)
  {
    glXDestroyContext(WinThreads[(signed long int)i].Dpy, WinThreads[(signed long int)i].Context);
...
static void create_window(struct winthread *wt, struct __GLXcontextRec *shareCtx)
{
  ...
  signed int attrib[11l] = { 4, 8, 1, 9, 1, 10, 1, 12, 1, 5, (signed int)0L };
  signed int scrnum;
  struct anonymous$29 attr;
  unsigned long int mask;
  unsigned long int root;
  struct anonymous$33 *visinfo;
  signed int width = 160;
  signed int height = 160;
  signed int xpos = (wt->Index % 8) * (width + 10);
  signed int ypos = (wt->Index / 8) * (width + 20);
  scrnum = ((struct anonymous$1 *)wt->Dpy)->default_screen;
  root = (&((struct anonymous$1 *)wt->Dpy)->screens[(signed long int)scrnum])->root;
  visinfo=glXChooseVisual(wt->Dpy, scrnum, attrib);
  if(visinfo == ((struct anonymous$33 *)NULL))
  ...
  XSetStandardProperties(wt->Dpy, win, "glthreads", "glthreads", (unsigned long int)0L, (char **)(void *)0, 0, &sizehints);
  ctx=glXCreateContext(wt->Dpy, visinfo, shareCtx, 1);
...
static void draw_loop(struct winthread *wt)
{
  for( ; ExitFlag == 0; wt->Angle = wt->Angle + (float)1.0)
  {
    if(!(Locking == 0))
...
signed int main(signed int argc, char **argv)
{
  ...
  pthread_mutex_init(&CondMutex, (const union anonymous *)(void *)0);
  pthread_cond_init(&CondVar, (const union anonymous *)(void *)0);
  printf("glthreads: creating windows\n");
  NumWinThreads = numThreads;
  i = 0;
  struct __GLXcontextRec *tmp_if_expr$7;
  for( ; !(i >= numThreads); i = i + 1)
  {
    struct __GLXcontextRec *share;
    if(!(MultiDisplays == 0))
    {
    ...
    if(i >= 1 && !(Texture == 0))
      tmp_if_expr$7 = WinThreads[(signed long int)0].Context;

    else
      tmp_if_expr$7 = ((struct __GLXcontextRec *)NULL);
    share = tmp_if_expr$7;
